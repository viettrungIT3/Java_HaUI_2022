...
public class Xe implements MayMoc {
    ...
    private String NL;
    private final DoanhNghiep dn = new DoanhNghiep();
    private float trongTai;
    private float tienDatCoc;
    private int namSX;

    public static void inTieuDe() {
        System.out.printf("%10s %10s %10s %25s %10s %10s %10s%n", " ten xe", "ten kh", " nhien lieu", " Doanh nghiep", " tai trọng", "tien DC", " Nam sx");
    }
